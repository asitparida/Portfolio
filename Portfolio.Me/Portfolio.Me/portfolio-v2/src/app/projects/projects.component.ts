...
const ProjectsArray: any[] = [
    { name: 'Not So Grey', desc: 'A desktop app for folks who dream colors', git: 'https://github.com/asitparida/NotSoGrey', img: 'assets/project-logos/notsogrey_app.png', href: "https://github.com/asitparida/NotSoGrey", size: 'double', width: '90%', height: 'auto', bgColor: '$EMERALD' },
    ...
    { name: 'Reddit - Concept Redesign', desc: 'Concept illustration for what Reddit may look like', git: 'https://github.com/asitparida/redesign-reddit', img: 'assets/project-logos/reddit.png', href: "http://redesign-reddit.azurewebsites.net/", width: '90%', height: 'auto', bgColor: '$ALIZARIN' },
    ...
    { name: 'TopGit', desc: 'Browse top projects on GitHub', git: 'https://github.com/asitparida/TopGit', img: 'assets/project-logos/topgit_app.png', href: "http://topgit.azurewebsites.net", width: '90%', height: 'auto', bgColor: '$EMERALD' },
    ...
    { name: 'Rich CC', desc: 'ng-plugin for showing calendar events', git: 'https://github.com/asitparida/RichCC', img: 'assets/project-logos/richcc.png', href: "http://richcc.azurewebsites.net",width: '90%', height: 'auto', bgColor: '$EMERALD' },
