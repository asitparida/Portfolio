...
const PROECTS_ARRAY: any[] = [
    ...
    { name: 'Now', desc: 'chrome extension for web notifications like github, mail, calendar etc', git: 'https://github.com/asitparida/Now', img: 'assets/project-logos/now.png', href: "https://github.com/asitparida/Now", width: '90%', height: 'auto', bgColor: '$PETER_RIVER' },
