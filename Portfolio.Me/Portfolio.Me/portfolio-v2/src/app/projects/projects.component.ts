...
const PROECTS_ARRAY: any[] = [
    ...
    { name: 'Reddit ', desc: 'Concept illustration for what Reddit may look like', git: 'https://github.com/asitparida/redesign-reddit', img: 'assets/project-logos/reddit.png', href: "http://redesign-reddit.azurewebsites.net/", width: '80%', height: 'auto', bgColor: '$ALIZARIN' },
    { name: 'Now', desc: 'chrome extension for web notifications like github, mail, calendar etc', git: 'https://github.com/asitparida/Now', img: 'assets/project-logos/now.jpg', href: "https://github.com/asitparida/Now", width: '100%', height: 'auto', bgColor: '$PETER_RIVER' },
    ...
    { name: 'Svg Flow Box', desc: 'Lightweight SVG based event highlighting on flows', git: 'https://github.com/asitparida/SVGFlowBox', img: 'assets/project-logos/svg-flow.png', href: "https://svg-flow-box.azurewebsites.net", width: '100%', height: 'auto', bgColor: '$PETER_RIVER' },
    { name: 'Light Wizard ', desc: 'A light weight angular2 wizard', git: 'https://github.com/asitparida/LightWizard', img: 'assets/project-logos/light-wizard2.png', href: "http://light-wizard.azurewebsites.net/", width: '80%', height: 'auto', bgColor: '$ALIZARIN' },
